...
checkpoint = "caps_net_epoch=17.pt"

cap_net = CapsulePostprocessor(dataset.ray_trafo)
cap_net.device = "cuda:5"
...
plot_activations = DCPPlotActivationsCallbackFunc(
    ...
    save_figure_path='../utils/figures', layer_indices=(-5, -4,-3, -2, -1), channels=8, overlay=False,
...
plot_activations = DCPPlotActivationsCallbackFunc(
    cap_net, name='dcp', gt=gt.cpu().squeeze(), 
    save_figure_path='../utils/figures', layer_indices=(-5, -4,-3, -2, -1), channels=8, overlay=True,
    overlay_normalize=False)
...
plot_activations = DCPPlotActivationsCallbackFunc(
    cap_net, name='dcp', gt=gt.cpu().squeeze(), 
    save_figure_path='../utils/figures', layer_indices=(0, 1, 2, 3), channels=8, overlay=False,
    overlay_normalize=False)
...
plot_activations = DCPPlotActivationsCallbackFunc(
    cap_net, name='dcp', gt=gt.cpu().squeeze(), 
    save_figure_path='../utils/figures', layer_indices=(0, 1, 2, 3), channels=8, overlay=True,
    overlay_normalize=False)
